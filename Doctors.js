...
app.post('bookingform',urlencodedParser,function(req,res){

	var appointmentOne=Appointment({name:req.body.name,age:req.body.age,date:req.body.date}).save(function(err,data){
	if(err) throw err;
});
